...
public class EqualsAvoidNullCheck extends AbstractCheck {
     ...
     */
    @SuppressWarnings({"determinism:argument.type.incompatible","determinism:method.invocation.invalid","determinism:assignment.type.incompatible"})  // logging: iteration over @OrderNonDet getChildren()
