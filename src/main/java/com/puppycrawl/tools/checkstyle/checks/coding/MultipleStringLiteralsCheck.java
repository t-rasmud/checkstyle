...
public class MultipleStringLiteralsCheck extends AbstractCheck {
    ...
    @Override
    @SuppressWarnings("determinism:argument.type.incompatible")  // false positive; logging: Iteration over OrderNonDet collection for logging; messages logged in a SortedSet.
