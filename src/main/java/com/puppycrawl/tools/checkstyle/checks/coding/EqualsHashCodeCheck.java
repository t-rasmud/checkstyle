...
public class EqualsHashCodeCheck
    ...
    @Override
    @SuppressWarnings({"determinism:method.invocation.invalid","determinism:argument.type.incompatible"})  // logging: iteration over OrderNonDet collection `objBlockWithHashCode` is ok because log() method uses SortedSet
