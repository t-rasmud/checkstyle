...
public class UniquePropertiesCheck extends AbstractFileSetCheck {
    ...
    @Override
    @SuppressWarnings({"determinism:argument.type.incompatible","determinism:method.invocation.invalid"})  // false positive; logging: iteration over OrderNonDet collection; messages logged in a SortedSet.
